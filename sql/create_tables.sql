...
ALTER TABLE public.coffees ALTER COLUMN CoffeId ADD GENERATED ALWAYS AS IDENTITY (
...
VALUES
    ('Café de Altura', 1, 1, 2, 1, 86.5, 'High', 'Medium', 'Good', 'Clear', 'Sweet', 1),
    ('Café Excelso', 2, 2, 3, 2, 85.0, 'Medium', 'Full', 'Good', 'Clear', 'Sweet', 2),
    ('Café Supremo', 3, 3, 4, 3, 83.5, 'Low', 'Medium', 'Fair', 'Clear', 'Sweet', 3),
    ('Café Gourmet', 4, 4, 5, 4, 82.0, 'High', 'Full', 'Good', 'Clear', 'Sweet', 4),
